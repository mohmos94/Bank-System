...
import modell.Database.Interface.IBank_Konto;
...
public class DBBank_Konto extends DB implements IBank_Konto {
    ...
    @Override
    public void insert( String kontonavn, String kontonummer, long balansen, int brukerID) throws SQLException {
        String insert = "insert into bank_konto (Kontonavn, Kontonummer, Balansen, BrukerID) values(?, ?,?,?);";
